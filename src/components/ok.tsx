...
const ConferenceImg = () => {
    return (
        <div className="w-full px-4 md:px-0 text-blue-700">
...
const Hero = ({}) => {
    return (
        <div className="max-w-screen min-h-screen flex items-center py-24">
            <div className="flex flex-col lg:flex-row-reverse gap-20 px-8 md:px-12 lg:px-16">
                <ConferenceImg />
                <div className="flex flex-col justify-center items-start">
                    ...
                    <div className="p-2 px-4 text-white rounded bg-blue-500">
                        Get Started
                    </div>
                </div>
            </div>
